...
namespace Takenet.MessagingHub.Client.Listener
{
    ...
    public static class MessagingHubListenerExtensions
    {
        ...
        /// <param name="forMimeType">The mime type used to filter the received messages</param>
        public static void AddMessageReceiver(this MessagingHubListener listener, Action<Message, CancellationToken> onMessageReceived, MediaType forMimeType = null)
        {
        ...
        /// <param name="forEventType">The event type used to filter the received notifications</param>
        public static void AddNotificationReceiver(this MessagingHubListener listener, Action<Notification, CancellationToken> onNotificationReceived, Event? forEventType = null)
        {
        ...
        /// <param name="messageFilter">The criteria to filter the messages</param>
        public static void AddMessageReceiver(this MessagingHubListener listener, Action<Message, CancellationToken> onMessageReceived, Predicate<Message> messageFilter)
        {
        ...
        /// <param name="notificationFilter">The criteria to filter the notifications</param>
        public static void AddNotificationReceiver(this MessagingHubListener listener, Action<Notification, CancellationToken> onNotificationReceived, Predicate<Notification> notificationFilter)
        {
